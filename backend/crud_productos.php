...
if (isset($_POST['registrar'])) {
    ...
    $sql_insert = "INSERT INTO productos (imagen, nombre, precio, cantidad_stock) VALUES ('$imagen', '$nombre', '$precio', '$cantidad_stock')";
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="number" name="precio" id="2">
        <label for="3">Cantidad de stock: </label>
        <input type="number" name="cantidad_stock" id="3">
        <label for="4">Imagen del producto: </label>
        <input type="file" name="imagen" id="4" accept="image/*" required>
    ...
    if (isset($_GET['id_editar'])) {
        ...
        <label for="1_e">Nombre: </label>
        <input type="text" name="nombre" id="1_e">
        <label for="2_e">Precio: </label>
        <input type="number" name="precio" id="2_e">
        <label for="3_e">Cantidad de stock: </label>
        <input type="number" name="cantidad_stock" id="3_e">
        <label for="4_e">Imagen del producto: </label>
        <input type="file" name="imagen" id="4_e" accept="image/*">
    ...
    if (isset($_POST['actualizar'])) {
        ...
        $sql_update = "UPDATE productos SET nombre='$nombre_editar', precio='$precio_editar', cantidad_stock='$cantidad_editar', imagen='$imagen' WHERE id_producto='$id_editar'";
